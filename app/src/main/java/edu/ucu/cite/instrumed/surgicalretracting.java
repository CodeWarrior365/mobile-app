...
public class surgicalretracting extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surgicalretracting);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.home:
                Intent intent=new Intent(surgicalretracting.this,MainActivity.class);
            ...
            case R.id.rate:
                ...
                break;
            case R.id.about:
                Intent aboutintent=new Intent(surgicalretracting.this,About.class);

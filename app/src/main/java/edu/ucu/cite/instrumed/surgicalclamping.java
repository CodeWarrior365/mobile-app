...
public class surgicalclamping extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_surgicalclamping);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.home:
                Intent intent=new Intent(surgicalclamping.this,MainActivity.class);
            ...
            case R.id.rate:
                ...
                break;
            case R.id.about:
                Intent aboutintent=new Intent(surgicalclamping.this,About.class);
